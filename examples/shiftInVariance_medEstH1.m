% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % This script reproduces the results of the shift-in-variance problem with moderate estimation constraint under H_1 presented in Section 7.2 and Appendix H of
